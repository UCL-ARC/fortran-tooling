...
contains
    ...
    !> Calculates the parameters which define the mesh but does not actually populate the mesh arrays
    !!
    !! @param[in]  box_size               The total length of one side of the box mesh, made up of multiple edges
    !! @param[in]  edge_size              The length of one edge within the box mesh
    !! @param[out] num_edges_per_boundary The number of edges along one side of the box
    !! @param[out] num_nodes              The total number of nodes in the mesh
    !! @param[out] num_boundary_nodes     The total number of nodes on the boundary of the mesh
    !! @param[out] num_elements           The total number of elements in the mesh
